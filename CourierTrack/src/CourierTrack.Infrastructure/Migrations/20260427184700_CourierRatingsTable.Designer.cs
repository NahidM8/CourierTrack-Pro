...
namespace CourierTrack.Infrastructure.Migrations
{
    ...
    [Migration("20260427184700_CourierRatingsTable")]
    partial class CourierRatingsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourierTrack.Domain.Entities.CourierRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CourierTrack.Domain.Entities.OrderStatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CourierTrack.Domain.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CourierTrack.Domain.Entities.CourierRating", b =>
                {
                    ...
                    b.HasOne("CourierTrack.Domain.Entities.Order", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("CourierTrack.Domain.Entities.Payment", b =>
                {
                    b.HasOne("CourierTrack.Domain.Entities.Order", "Order")
                        .WithOne()
                        .HasForeignKey("CourierTrack.Domain.Entities.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
